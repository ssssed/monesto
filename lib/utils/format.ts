...
export function createEmptyIncomeEntry(): import('@/lib/types').MoneyFlowEntry {
  return {
...
export function createEmptyExpenseEntry(): import('@/lib/types').MoneyFlowEntry {
  return {
    id: `${Date.now()}-${Math.random()}`,
    name: '',
    amount: '',
...
export function incomesToEntries(
  incomes: import('@/lib/types').IncomeSource[],
): import('@/lib/types').MoneyFlowEntry[] {
...
export function expensesToEntries(
